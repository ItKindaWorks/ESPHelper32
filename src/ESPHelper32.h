...
#ifndef ESP_HELPER32_H
#define ESP_HELPER32_H
...
public:
	ESPHelper32();
	ESPHelper32(const netInfo *startingNet);
	ESPHelper32(netInfo *netList[], uint8_t netCount, uint8_t startIndex = 0);	//remember netInfo *netList[] is really netinfo**
	ESPHelper32(const char *ssid, const char *pass, const char *mqttIP);
	ESPHelper32(const char *ssid, const char *pass);
	ESPHelper32(const char *ssid, const char *pass, const char *mqttIP, const char *mqttUser, const char *mqttPass, const int mqttPort);
